...
export const STEPS: Step[] = [
  {
    num: "01",
    title: "把稿子写完",
    desc: "即时渲染在一个窗口里写完，或者左源码右预览地对照着写。截图粘进来自动进图床。",
  },
  {
    num: "02",
    title: "挑一套主题",
    desc: "13 套主题即点即换，预览里的样子就是公众号里的最终效果；不够贴合再叠一层自定义 CSS。",
  },
  {
    num: "03",
    title: "复制，粘贴，发布",
    desc: "点「复制到公众号」，进后台粘贴即可；也可以复制到知乎，或导出 Word、PDF、长图。",
  },
];
...
export const FAQ: FaqItem[] = [
  ...
  },
  {
    ...
    a: "有 Mac 客户端，支持 Apple Silicon 的 macOS 12 及以上，提供登录态持久化、原生菜单与快捷键、离线提示等桌面体验，还能一键把写好的文章发送到公众号草稿箱，数据与网页版完全同步。安装包正在准备对外发布，可以先到 GitHub 仓库关注进展。Windows 暂时没有独立客户端，但网页版在 Windows 上功能完全一致。",
  },
  {
    q: "除了公众号，还能发到别的平台吗？",
